...
function wzs21_custom_file() {
    //zulsarhan
    wp_enqueue_style('bootstrap', get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css');
    wp_enqueue_style('wzs21_search', get_template_directory_uri() . '/css/wzs21_css/search.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_chat', get_template_directory_uri() . '/css/wzs21_css/chat.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_card', get_template_directory_uri() . '/css/wzs21_css/card.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_modal', get_template_directory_uri() . '/css/wzs21_css/modal.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_general', get_template_directory_uri() . '/css/wzs21_css/general.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_company', get_template_directory_uri() . '/css/wzs21_css/company.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_admin_panel', get_template_directory_uri() . '/css/wzs21_css/admin_panel.css', array(), CUSTOM_CSS_VERSION);
    wp_enqueue_style('wzs21_note_card', get_template_directory_uri() . '/css/wzs21_css/note_card.css', array(), CUSTOM_CSS_VERSION);
...
function zerif_scripts() {
    ...
    wp_enqueue_style('zerif_style', get_stylesheet_uri(), array('zerif_fontawesome'), CUSTOM_CSS_VERSION);
    ...
    //wp_enqueue_style('custom_1', get_template_directory_uri() . '/css/custom_1.css', array(), CUSTOM_CSS_VERSION);
...
if (!class_exists('zerif_ourfocus') && zerif_check_if_old_version_of_theme()) {
    ...
    class zerif_ourfocus extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                    'ctUp-ads-widget', __('Zerif - Our focus widget', 'zerif-lite'), array(
        ...
        function widget($args, $instance) {
            ...
            <div class="col-lg-3 col-sm-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
                ...
                <h3 class="red-border-bottom"><?php
...
if (!class_exists('zerif_testimonial_widget') && zerif_check_if_old_version_of_theme()) {
    ...
    class zerif_testimonial_widget extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                    'zerif_testim-widget', __('Zerif - Testimonial widget', 'zerif-lite'), array(
                'customize_selective_refresh' => true,
                    )
            );
            add_action('admin_enqueue_scripts', array($this, 'widget_scripts'));
            ...
            <div class="client">
                ...
                <div class="client-info">
                    ...
                    <a <?php echo $attribut_new_tab; ?>
                        class="client-name" <?php
            if (!empty($instance['link'])): echo 'href="' . esc_url($instance['link']) . '"';
            endif;
            ?>><?php
                        if (!empty($instance['title'])): echo apply_filters('widget_title', $instance['title']);
                        endif;
        ...
        function form($instance) {
            ...
            <p>
                ...
                <input type="text" name="<?php echo $this->get_field_name('details'); ?>"
                       ...
                       value="<?php
            if (!empty($instance['details'])): echo $instance['details'];
            endif;
            ?>"
                       class="widefat">
            </p>
            ...
            if (!empty($zerif_image_in_customizer)) {
                ...
                ?>"
                       value="<?php
            if (!empty($instance['image_in_customizer'])): echo $instance['image_in_customizer'];
            endif;
                ?>">
...
if (!class_exists('zerif_clients_widget') && zerif_check_if_old_version_of_theme()) {
    ...
    class zerif_clients_widget extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                    'zerif_clients-widget', __('Zerif - Clients widget', 'zerif-lite'), array(
                'customize_selective_refresh' => true,
                    )
            );
            add_action('admin_enqueue_scripts', array($this, 'widget_scripts'));
       ...
       if (!class_exists('zerif_team_widget') && zerif_check_if_old_version_of_theme()) {
           ...
           class zerif_team_widget extends WP_Widget {
               ...
               public function __construct() {
                   parent::__construct(
                           'zerif_team-widget', __('Zerif - Team member widget', 'zerif-lite'), array(
                       'customize_selective_refresh' => true,
                           )
                   );
                   add_action('admin_enqueue_scripts', array($this, 'widget_scripts'));
        ...
        function form($instance) {
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name('open_new_window'); ?>"
                       id="<?php echo $this->get_field_id('open_new_window'); ?>" <?php
